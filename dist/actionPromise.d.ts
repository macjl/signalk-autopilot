 ...
 */
export declare const ACTION_FAILURE_STATUS_CODE = 400;
/**
 ...
 */
export declare function toActionPromise(invoke: (cb: (res: ActionResult) => void) => ActionResult): Promise<void>;
//# sourceMappingURL=actionPromise.d.ts.map