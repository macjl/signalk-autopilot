...
exports.ACTION_FAILURE_STATUS_CODE = void 0;
exports.toActionPromise = toActionPromise;
/**
 ...
 */
exports.ACTION_FAILURE_STATUS_CODE = 400;
/**
 ...
 */
function toActionPromise(invoke) {
    return new Promise((resolve, reject) => {
        const res = invoke((finalRes) => {
            if (finalRes.statusCode === exports.ACTION_FAILURE_STATUS_CODE) {
                reject(finalRes);
            }
            else {
                resolve();
        ...
        if (res.state !== 'PENDING') {
            if (res.statusCode === exports.ACTION_FAILURE_STATUS_CODE) {
                reject(res);
            }
            else {
                resolve();
...
//# sourceMappingURL=actionPromise.js.map